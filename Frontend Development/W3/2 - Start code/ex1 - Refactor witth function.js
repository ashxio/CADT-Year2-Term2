...
// Check that your code can work with mini shopping carts
...
let minishoppingCart = [
  { name: "Blueberry", price: 4, quantity: 1 },
  { name: "Strawberry", price: 5, quantity: 1 },
]
...
// mini cart
console.log(`Total price: ${calculateTotalPrice(minishoppingCart)}$`
);
