...
const STUDENTS_DATA = [
  { firstName: "An", lastName: "Ko", batch: "001", age: 20 },
  { firstName: "Bình", lastName: "Nguyen", batch: "002", age: 22 },
  { firstName: "Cẩm", lastName: "Ed", batch: "003", age: 21 },
  { firstName: "An", lastName: "Nha", batch: "004", age: 19 }, // Duplicate first name !
];
 ...
 * @param {string} batch - the student ID
